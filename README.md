...
- **무료**: FAI는 무료입니다. 누구나 비용 없이 사용할 수 있습니다.
- **누구나, 언제든지 참여 가능**: 컴퓨터만 있으면 누구든 자유롭게 참여하고, 원할 때 떠날 수 있습니다.
- **참여한 만큼 사용**: 컴퓨팅 파워를 기여한 만큼 API 사용량(토큰 크레딧)을 적립받아, 학습된 AI 모델을 사용할 수 있습니다.
...
- **완전 오픈소스**: 익명의 참여로 만들어진 AI인 만큼 100% 오픈소스로, 최소한의 운영비를 위한 수익화
